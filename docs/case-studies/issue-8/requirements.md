...
| R-L10 | All JavaScript code lives under `./js`.                                                                                                                    | "Make sure all JavaScript code in ./js folder … Like in our templates"                                                           |
| R-L11 | All Rust code lives under `./rust`.                                                                                                                        | "all rust code in ./rust folder. Like in our templates"                                                                          |
...
| R-L10a | The repository structure should be documented and matched to the templates: all JavaScript code lives under `js/`, and all Rust code lives under `rust/`.                     |
| R-L12a | The CI/CD comparison must enumerate every workflow file and every script in `.github/workflows/` and `js/scripts/`, and mark each as parity, intentionally-different, or gap. |
