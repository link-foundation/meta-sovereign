...
export const hi = {
  ...
  'settings.openConnections': 'कनेक्शन खोलें',
  ...
  'guide.openSettingsTarget': 'कनेक्शन → {label}',
  'guide.openSettingsRoot': 'कनेक्शन',
  'guide.openConnections': '{target} खोलें',
  'guide.openConnectionsTarget': 'कनेक्शन → {label}',
  'guide.openConnectionsRoot': 'कनेक्शन',
  'guide.probeDisabled':
    '{label} जाँच सक्षम करने के लिए कनेक्शन में क्रेडेंशियल दर्ज करें।',
  ...
  'guide.chat.body':
    'meta-sovereign हर जुड़ी सेवा की हर चैट को एक जगह रखता है। कनेक्शन खोलकर प्रदाता जोड़ें या निर्यात संग्रह आयात करें, फिर यहाँ लौटें।',
  'guide.operator.title': 'ऑपरेटर क़तार खाली है।',
  'guide.operator.body':
    'ऑपरेटर कार्ड स्ट्रीम आपको चैट-दर-चैट अपठित संदेशों के बीच ले जाती है। कनेक्शन खोलकर चैट-सक्षम प्रदाता जोड़ें।',
  'guide.contacts.title': 'अभी कोई संपर्क नहीं।',
  'guide.contacts.body':
    'संपर्क सभी जुड़े प्रदाताओं से एकत्रित होते हैं ताकि नेटवर्क में एक ही व्यक्ति केवल एक बार दिखे। सूची भरने के लिए कनेक्शन में प्रदाता जोड़ें।',
  'guide.automation.title': 'अभी कोई स्वचालन ग्राफ़ नहीं।',
  'guide.automation.body':
    'स्वचालन ग्राफ़ आने वाले संदेशों को पैटर्न से जवाब विविधता तक रूट करते हैं। स्वचालन बनाने से पहले कनेक्शन में प्रदाता डेटा आयात करें।',
  'guide.patterns.title': 'अभी कोई पैटर्न नहीं।',
  'guide.patterns.body':
    'पैटर्न उदाहरण संदेशों से निकाले जाते हैं। कनेक्शन खोलकर प्रदाता जोड़ें या संग्रह आयात करें, फिर उदाहरणों के साथ लौटें।',
  'guide.replies.title': 'अभी कोई जवाब विविधता समूह नहीं।',
  'guide.replies.body':
    'जवाब समूह आपके पिछले बाहर जाने वाले संदेशों से धुँधली समानता द्वारा निकाले जाते हैं। जवाब लाइब्रेरी भरने के लिए कनेक्शन में चैट-सक्षम प्रदाता जोड़ें।',
  'guide.facts.title': 'अभी कोई तथ्य नहीं निकाले।',
  'guide.facts.body':
    'तथ्य आपके पैटर्न द्वारा संदेशों में पाए गए "प्रश्न -> उत्तर" युग्म हैं। कनेक्शन में डेटा जोड़ें, फिर यहाँ कैप्चर पैटर्न बनाएँ।',
  'guide.audience.title': 'अपना पहला श्रोता बनाएँ।',
  'guide.audience.body':
    'AND/OR/NOT तथा network:, chat:, sender:, kind:, fact: जैसे आयामों से संपर्कों को क्रॉस-रेफरेंस करें। पहले कनेक्शन में कम से कम एक प्रदाता जोड़ें।',
  'guide.broadcast.title': 'अभी कोई प्रसारण लक्ष्य नहीं।',
  'guide.broadcast.body':
    'प्रसारण समान संदेश हर जुड़े फ़ीड पर पोस्ट करते हैं। लक्ष्य चेकबॉक्स सक्षम करने के लिए कनेक्शन में सार्वजनिक-पोस्टिंग प्रदाता जोड़ें।',
  'guide.outreach.title': 'अभी कोई पहुँच लक्ष्य नहीं।',
  'guide.outreach.body':
    'सामूहिक-व्यक्तिगत पहुँच श्रोता क्वेरी के हर संपर्क को टेम्प्लेटयुक्त संदेश 1:1 भेजती है। कनेक्शन में चैट-सक्षम प्रदाता जोड़ें।',
  'guide.profile.title': 'अभी कोई प्रोफ़ाइल नहीं।',
  'guide.profile.body':
    'अपनी प्रोफ़ाइल और रिज़्यूमे यहाँ संपादित करें; सहेजने पर हर जुड़े प्रदाता तक पुश हो जाते हैं। प्रोफ़ाइल सिंक के लिए कनेक्शन में कम से कम एक प्रदाता जोड़ें।',
  ...
  'tutorial.connect.title': 'पहले कोई सेवा जोड़ें',
  'tutorial.connect.body':
    'जब तक आप कम से कम एक प्रदाता नहीं जोड़ते तब तक meta-sovereign खाली रहता है। हाइलाइट किए गए "कनेक्शन" बटन पर टैप करके प्रति-प्रदाता सेटअप स्क्रीन खोलें — आप इस ट्यूटोरियल पर कभी भी लौट सकते हैं।',
