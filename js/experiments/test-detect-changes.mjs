...
test('.mjs file change', ['js/scripts/detect-code-changes.mjs'], {
  anyCodeChanged: true,
  mjsChanged: true,
  jsChanged: false,
});

test('.js file change', ['js/src/index.js'], {
  anyCodeChanged: true,
  jsChanged: true,
  mjsChanged: false,
});
...
test(
  'js/experiments/ folder excluded from code changes',
  ['js/experiments/test.mjs'],
  {
    anyCodeChanged: false,
  }
);
...
test(
  'js/examples/ folder excluded from code changes',
  ['js/examples/demo.js'],
  {
    anyCodeChanged: false,
  }
...
test(
  ...
  ['.gitkeep', 'js/scripts/detect-code-changes.mjs'],
  {
    anyCodeChanged: true,
    mjsChanged: true,
  }
...
test('YAML config change', ['js/eslint.config.js'], {
  anyCodeChanged: true,
  jsChanged: true,
});
