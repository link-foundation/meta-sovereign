...
export default [
  ...
  },
  {
    ...
    files: ['js/src/sync/bun-server.js'],
    languageOptions: {
      globals: {
        Response: 'readonly',
        Request: 'readonly',
  ...
  },
  {
    ignores: [
      ...
      // Build output: rustdoc HTML/JS bundle, generated by `cargo doc`.
      'target/**',
      'rust/target/**',
      // Generated API docs from `npm run docs:api`.
      'docs/api/**',
    ],
  },
];
